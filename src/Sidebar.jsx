    ...
    return (
        <div className="border-2 rounded-xl">
            ...
            <div className="flex items-center justify-center p-4">
                <h1 className="text-2xl font-semibold pb-2 border-b-2 w-[350px] text-center">Want to cook: 01</h1>
            </div>
            <div className="mb-4">
            ...
            <div className="p-4 flex gap-3 items-center bg-[#28282808] mb-8">
                ...
                <h3 className="w-[170px]">i am ashraful islam. i am 20 year s old </h3>
                <h3 className="w-2/11">20 minutes</h3>
                <h3 className="w-2/11 ml-4">400 calories</h3>
